...
type TripServiceClient interface {
	...
	GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripRequest, error)
...
func (c *tripServiceClient) GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripRequest, error) {
	out := new(GetTripRequest)
...
type TripServiceServer interface {
	...
	GetTrips(context.Context, *GetTripsRequest) (*GetTripRequest, error)
...
func (UnimplementedTripServiceServer) GetTrips(context.Context, *GetTripsRequest) (*GetTripRequest, error) {
